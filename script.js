...
let showBankBtn = document.getElementById("show-bank-btn");
...
closeModal.onclick = function () {
  console.log("ba boom boom boom boom");
...
showBankBtn.addEventListener("click", showBank);
